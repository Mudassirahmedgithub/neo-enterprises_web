...
const handleSubmit = async (e) => {
  e.preventDefault();
  const fullFormData = { ...formData, product: selectedProduct };
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | Neo Enterprises — Get in Touch for Granite, Spices, and Agro Products</title>
        <meta
          name="description"
          content="Contact Neo Enterprises for inquiries about premium granite, spices, and agro exports. Reach us for quotations, partnerships, or product details."
        />
        <link rel="canonical" href="https://theneoenterprises.com/contact" />
        <meta property="og:title" content="Contact Neo Enterprises — Global Supplier of Granite, Spices & Agro Products" />
        <meta
          property="og:description"
          content="Get in touch with Neo Enterprises for premium granite, spices, and agro product inquiries. Connect for export, trade, or business opportunities."
        />
        <meta property="og:url" content="https://theneoenterprises.com/contact" />
