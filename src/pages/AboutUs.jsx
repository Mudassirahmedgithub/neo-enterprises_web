...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About Us | Neo Enterprises — Trusted Supplier & Exporter of Granite, Spices, and Agro Products</title>
        <meta
          name="description"
          content="Learn about Neo Enterprises, a global supplier and exporter of premium granite, spices, and agro products. Trusted for quality, integrity, and excellence since 1979."
        />
        <link rel="canonical" href="https://theneoenterprises.com/about" />
        <meta property="og:title" content="About Neo Enterprises — Leading Supplier of Granite, Spices & Agro Products" />
        <meta
          property="og:description"
          content="Discover Neo Enterprises’ legacy of excellence in exporting granite, spices, and agro products worldwide with unmatched quality and reliability."
        />
        <meta property="og:url" content="https://theneoenterprises.com/about" />
