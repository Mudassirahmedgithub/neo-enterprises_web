...
export default function Sitemap() {
  ...
  return (
    <>
      <Helmet>
        <title>Sitemap | Neo Enterprises — Explore All Pages and Product Categories</title>
        <meta
          name="description"
          content="Browse the complete sitemap of Neo Enterprises, featuring all pages, product categories, and granite collections. Easily navigate to our offerings and legal pages."
        />
        <link rel="canonical" href="https://www.theneoenterprises.com/Sitemap" />
        <meta property="og:title" content="Sitemap | Neo Enterprises" />
        <meta
          property="og:description"
          content="Discover Neo Enterprises’ sitemap for quick access to all pages, granite varieties, spices, and agro product listings."
        />
        <meta property="og:url" content="https://www.theneoenterprises.com/Sitemap" />
