...
export default function GraniteNeoTanRed() {
  ...
  const handleSubmit = (e) => {
    ...
    submitForm('TanRed', formData, setStatus, () =>
      setForm({
        name: '',
        email: '',
        countryCode: '91',
  ...
  return (
    <>
      <Helmet>
        <title>
          Neo Tan Red Granite | Premium Polished Natural Stone Slabs and Tiles – Neo Enterprises
        </title>
        <meta
          name="description"
          content="Explore Neo Tan Red Granite from Neo Enterprises — premium polished granite slabs and tiles from Telangana, India. Ideal for flooring, countertops, staircases, and architectural applications in residential and commercial projects."
        />
        <meta
          name="keywords"
          content="Neo Tan Red Granite, Granite Supplier India, Polished Granite Slabs, Granite Tiles Exporter, Tan Red Granite Price, Neo Enterprises Granite, Countertop Granite, Floor Granite, Building Facade Stone, Indian Granite Exporter"
        />
        <meta property="og:title" content="Neo Tan Red Granite | Premium Polished Slabs and Tiles – Neo Enterprises" />
        <meta
          property="og:description"
          content="Discover Neo Tan Red Granite by Neo Enterprises — premium natural stone perfect for countertops, flooring, and architectural designs."
        />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/tan_red1.JPG" />
        <meta property="og:url" content="https://theneoenterprises.com/products/granite/NeoTanRed" />
        <meta property="og:type" content="product" />
        <link rel="canonical" href="https://theneoenterprises.com/products/granite/NeoTanRed" />
        ...
        <div className='max-w-6xl mx-auto bg-white shadow-md rounded-2xl overflow-hidden'>
          <div className='md:flex'>
            ...
            <div className='md:w-1/2 w-full overflow-hidden'>
              <img
                src='/images/products/tan_red1.JPG'
          ...
          <div className='p-8 border-t'>
            <div className='max-w-4xl mx-auto'>
              <h3 className='text-xl font-semibold text-gray-900'>
                Looking for "Granite – Neo Tan Red" ?
              </h3>
