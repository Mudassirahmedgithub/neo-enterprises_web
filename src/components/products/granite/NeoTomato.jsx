...
export default function GraniteNeoTomato() {
  ...
  const handleSubmit = (e) => {
    ...
    submitForm('TomatoRed', formData, setStatus, () =>
      setForm({
        name: '',
        email: '',
        countryCode: '91',
  ...
  return (
    <>
      <Helmet>
        <title>
          Neo Tomato Red Granite | Premium Polished Natural Stone Slabs and Tiles – Neo Enterprises
        </title>
        <meta
          name="description"
          content="Purchase Neo Tomato Red Granite from Neo Enterprises — top supplier and exporter from Telangana, India. Ideal for countertops, floors, and wall cladding. Premium polished granite slabs and tiles for residential and commercial projects."
        />
        <meta
          name="keywords"
          content="Neo Tomato Red Granite, Granite Supplier India, Polished Granite Slabs, Granite Tiles Exporter, Neo Tomato Granite Price, Neo Enterprises Granite, Countertop Granite, Floor Granite, Building Facade Stone, Indian Granite Exporter"
        />
        <meta property="og:title" content="Neo Tomato Red Granite | Premium Polished Slabs and Tiles – Neo Enterprises" />
        <meta
          property="og:description"
          content="Explore Neo Tomato Red Granite by Neo Enterprises — premium polished natural stone ideal for flooring, countertops, and architectural applications."
        />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/tomato-red.JPG" />
        <meta property="og:url" content="https://theneoenterprises.com/products/granite/NeoTomato" />
        <meta property="og:type" content="product" />
        <link rel="canonical" href="https://theneoenterprises.com/products/granite/NeoTomato" />
        ...
        <div className='max-w-6xl mx-auto bg-white shadow-md rounded-2xl overflow-hidden'>
          <div className='md:flex'>
            ...
            <div className='md:w-1/2 w-full overflow-hidden'>
              <img
                src='/images/products/tomato-red.JPG'
          ...
          <div className='p-8 border-t'>
            <div className='max-w-4xl mx-auto'>
              <h3 className='text-xl font-semibold text-gray-900'>
                Looking for "Granite – Neo Tomato" ?
              </h3>
