...
export default function GraniteNeoChocolate() {
  ...
  const handleSubmit = (e) => {
    ...
    submitForm('Chocolate_lapotra', formData, setStatus, () =>
      setForm({
        name: '',
        email: '',
        countryCode: '91',
  ...
  return (
    <>
      <Helmet>
        <title>
          Neo Chocolate Granite | Premium Polished Natural Stone Slabs and Tiles – Neo Enterprises
        </title>
        <meta
          name="description"
          content="Discover Neo Chocolate Granite from Neo Enterprises — premium polished granite slabs and tiles from Telangana, India. Perfect for flooring, countertops, staircases, and architectural applications in both residential and commercial projects."
        />
        <meta
          name="keywords"
          content="Neo Chocolate Granite, Granite Supplier India, Polished Granite Slabs, Granite Tiles Exporter, Neo Enterprises Granite, Countertop Granite, Floor Granite, Building Facade Stone, Indian Granite Exporter"
        />
        <meta property="og:title" content="Neo Chocolate Granite | Premium Polished Slabs and Tiles – Neo Enterprises" />
        <meta
          property="og:description"
          content="Explore Neo Chocolate Granite by Neo Enterprises — premium natural stone ideal for countertops, flooring, and high-end architectural designs."
        />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/chocolata-lapota1.JPG" />
        <meta property="og:url" content="https://theneoenterprises.com/products/granite/NeoChocolate" />
        <meta property="og:type" content="product" />
        <link rel="canonical" href="https://theneoenterprises.com/products/granite/NeoChocolate" />
        ...
        <div className='max-w-6xl mx-auto bg-white shadow-md rounded-2xl overflow-hidden'>
          <div className='md:flex'>
            ...
            <div className='md:w-1/2 w-full overflow-hidden'>
              <img
                src='/images/products/chocolata-lapota1.JPG'
