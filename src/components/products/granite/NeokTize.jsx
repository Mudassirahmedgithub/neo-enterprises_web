...
export default function GraniteNeokTize() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Neo k Tize Granite | Premium Polished Natural Stone Slabs and Tiles – Neo Enterprises
        </title>
        <meta
          name="description"
          content="Discover Neo k Tize Granite from Neo Enterprises — premium polished granite slabs and tiles from Telangana, India. Perfect for flooring, countertops, staircases, and architectural applications in both residential and commercial projects."
        />
        <meta
          name="keywords"
          content="Neo k Tize Granite, Granite Supplier India, Polished Granite Slabs, Granite Tiles Exporter, Neo Enterprises Granite, Countertop Granite, Floor Granite, Building Facade Stone, Indian Granite Exporter"
        />
        <meta property="og:title" content="Neo k Tize Granite | Premium Polished Slabs and Tiles – Neo Enterprises" />
        <meta
          property="og:description"
          content="Explore Neo k Tize Granite by Neo Enterprises — premium natural stone ideal for countertops, flooring, and high-end architectural designs."
        />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/k_tize1.JPG" />
        <meta property="og:url" content="https://theneoenterprises.com/products/granite/NeoKTize" />
        <meta property="og:type" content="product" />
        <link rel="canonical" href="https://theneoenterprises.com/products/granite/NeoKTize" />
