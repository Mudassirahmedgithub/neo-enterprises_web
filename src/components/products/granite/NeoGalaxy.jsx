...
export default function GraniteNeoGalaxy() {
  ...
  const handleSubmit = (e) => {
    ...
    submitForm('Black_Shade', formData, setStatus, () =>
      setForm({
        name: '',
        email: '',
        countryCode: '91',
  ...
  return (
    <>
      <Helmet>
        <title>
          Neo Galaxy Black Granite | Premium Polished Natural Stone Slabs and Tiles – Neo Enterprises
        </title>
        <meta
          name="description"
          content="Discover Neo Galaxy Black Granite from Neo Enterprises — premium polished granite slabs and tiles from Telangana, India. Perfect for flooring, countertops, staircases, and architectural applications in both residential and commercial projects."
        />
        <meta
          name="keywords"
          content="Neo Galaxy Black Granite, Granite Supplier India, Polished Granite Slabs, Granite Tiles Exporter, Neo Enterprises Granite, Countertop Granite, Floor Granite, Building Facade Stone, Indian Granite Exporter"
        />
        <meta property="og:title" content="Neo Galaxy Black Granite | Premium Polished Slabs and Tiles – Neo Enterprises" />
        <meta
          property="og:description"
          content="Explore Neo Galaxy Black Granite by Neo Enterprises — premium natural stone ideal for countertops, flooring, and high-end architectural designs."
        />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/black_shade1.JPG" />
        <meta property="og:url" content="https://theneoenterprises.com/products/granite/NeoGalaxy" />
        <meta property="og:type" content="product" />
        <link rel="canonical" href="https://theneoenterprises.com/products/granite/NeoGalaxy" />
        ...
        <div className='max-w-6xl mx-auto bg-white shadow-md rounded-2xl overflow-hidden'>
          <div className='md:flex'>
            ...
            <div className='md:w-1/2 w-full overflow-hidden'>
              <img
                src='/images/products/black_shade1.JPG'
          ...
          <div className='p-8 border-t'>
            <div className='max-w-4xl mx-auto'>
              <h3 className='text-xl font-semibold text-gray-900'>
                Looking for "Granite – Neo Galaxy" ?
              </h3>
