...
export default function StarBlue() {
  ...
  const handleSubmit = (e) => {
    ...
    submitForm('StarBlue', formData, setStatus, () =>
      setForm({
        name: '',
        email: '',
        countryCode: '91',
  ...
  return (
    <>
      <Helmet>
        <title>
          Star Blue Granite | Premium Polished Natural Stone Slabs and Tiles – Neo Enterprises
        </title>
        <meta
          name="description"
          content="Buy Star Blue Granite from Neo Enterprises — top exporter and supplier from Telangana, India. Ideal for countertops, floors, and wall cladding. Premium polished granite slabs and tiles for interiors and exteriors."
        />
        <meta
          name="keywords"
          content="Star Blue Granite, Granite Supplier India, Polished Granite Slabs, Granite Tiles Exporter, Star Blue Granite Price, Neo Enterprises Granite, Countertop Granite, Floor Granite, Building Facade Stone, Indian Granite Exporter"
        />
        <meta property="og:title" content="Star Blue Granite | Premium Polished Slabs and Tiles – Neo Enterprises" />
        <meta
          property="og:description"
          content="Explore Star Blue Granite by Neo Enterprises — a premium polished natural stone ideal for flooring, countertops, and architectural applications."
        />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/star_blue1.JPG" />
        <meta property="og:url" content="https://theneoenterprises.com/products/granite/StarBlue" />
        <meta property="og:type" content="product" />
        <link rel="canonical" href="https://theneoenterprises.com/products/granite/StarBlue" />
