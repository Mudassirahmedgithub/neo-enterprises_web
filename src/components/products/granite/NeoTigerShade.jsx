...
export default function GraniteNeoTigerShade() {
  ...
  const handleSubmit = (e) => {
    ...
    submitForm('TigerShade', formData, setStatus, () =>
      setForm({
        name: '',
        email: '',
        countryCode: '91',
  ...
  const moreProducts = [
    ...
    {
      title: 'Neo K Tize',
      href: '/products/granite/NeoKTize',
  ...
  return (
    <>
      <Helmet>
        <title>
          Neo Tiger Shade Granite | Premium Polished Natural Stone Slabs and Tiles – Neo Enterprises
        </title>
        <meta
          name="description"
          content="Discover Neo Tiger Shade Granite from Neo Enterprises — premium polished granite slabs and tiles from Telangana, India. Perfect for countertops, flooring, and architectural applications in residential and commercial projects."
        />
        <meta
          name="keywords"
          content="Neo Tiger Shade Granite, Granite Supplier India, Polished Granite Slabs, Granite Tiles Exporter, Tiger Shade Granite Price, Neo Enterprises Granite, Countertop Granite, Floor Granite, Building Facade Stone, Indian Granite Exporter"
        />
        <meta property="og:title" content="Neo Tiger Shade Granite | Premium Polished Slabs and Tiles – Neo Enterprises" />
        <meta
          property="og:description"
          content="Explore Neo Tiger Shade Granite by Neo Enterprises — premium natural stone ideal for flooring, countertops, and architectural designs."
        />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/tiger1.JPG" />
        <meta property="og:url" content="https://theneoenterprises.com/products/granite/NeoTigerShade" />
        <meta property="og:type" content="product" />
        <link rel="canonical" href="https://theneoenterprises.com/products/granite/NeoTigerShade" />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="Neo Enterprises" />
        <meta name="geo.region" content="IN-TG" />
        <meta name="geo.placename" content="Telangana, India" />
        <meta name="geo.position" content="17.1232;79.2088" />
        <meta name="ICBM" content="17.1232, 79.2088" />
      </Helmet>
        ...
        <div className='max-w-6xl mx-auto bg-white shadow-md rounded-2xl overflow-hidden'>
          <div className='md:flex'>
            ...
            <div className='md:w-1/2 w-full overflow-hidden'>
              <img
                src='/images/products/tiger1.JPG'
          ...
          <div className='p-8 border-t'>
            <div className='max-w-4xl mx-auto'>
              <h3 className='text-xl font-semibold text-gray-900'>
                Looking for "Granite – Neo Tiger Shade" ?
              </h3>
