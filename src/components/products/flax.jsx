...
export default function Flax() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Flax Seeds Exporter from India | Neo Enterprises — Premium Linseed Manufacturer & Supplier
        </title>
        <meta
          name="description"
          content="Neo Enterprises is a leading exporter and supplier of high-quality Flax Seeds (Linseed) from India. Naturally cultivated, rich in Omega-3, fiber, and protein. Available in bulk packaging for food, oil extraction, and nutritional applications."
        />
        <meta
          name="keywords"
          content="Flax Seeds exporter India, Linseed supplier, bulk flaxseed exporter, flax seeds manufacturer, organic flax seeds, oilseed exporter India, Neo Enterprises, buy flax seeds online"
        />
        <meta name="author" content="Neo Enterprises" />
        <meta name="robots" content="index, follow" />

        <meta property="og:title" content="Flax Seeds Exporter from India | Neo Enterprises" />
        <meta
          property="og:description"
          content="Premium Flax Seeds (Linseed) exported from India by Neo Enterprises — rich in Omega-3, fiber, and protein. Ideal for food, oil, and health industries."
        />
        <meta property="og:type" content="product" />
        <meta property="og:url" content="https://theneoenterprises.com/products/flax-seeds" />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/flax-seeds.png" />
        <meta property="og:site_name" content="Neo Enterprises" />

        <link rel="canonical" href="https://theneoenterprises.com/products/flax-seeds" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Flax Seeds Exporter from India | Neo Enterprises" />
        <meta
          name="twitter:description"
          content="Export-quality Flax Seeds (Linseed) from Neo Enterprises — ideal for oil extraction, bakery, nutrition, and pharmaceutical applications."
        />
        <meta name="twitter:image" content="https://theneoenterprises.com/images/products/flax-seeds.png" />
          ...
          {`
            {
              ...
              "@type": "Product",
              "name": "Flax Seeds",
              "image": "https://theneoenterprises.com/images/products/flax-seeds.png",
              "description": "Premium Flax Seeds (Linseed) cultivated and exported from India by Neo Enterprises. Rich in Omega-3, protein, and fiber — suitable for food, oil extraction, and pharmaceutical industries.",
              "brand": {
                "@type": "Brand",
              ...
              "offers": {
                ...
                "priceCurrency": "USD",
                "url": "https://theneoenterprises.com/products/flax-seeds"
              },
              "additionalProperty": [
                {
                  "@type": "PropertyValue",
