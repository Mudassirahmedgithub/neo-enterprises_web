...
export default function Cardamom() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Cardamom Exporter from India | Neo Enterprises — Premium Green Elaichi Manufacturer & Supplier
        </title>
        <meta
          name="description"
          content="Neo Enterprises is a trusted manufacturer, supplier, and exporter of premium-grade Green Cardamom (Elaichi) from India. Naturally cultivated and expertly graded for rich aroma and flavor. Available in bulk and customized packaging."
        />
        <meta
          name="keywords"
          content="Cardamom exporter India, Green Elaichi supplier, Indian cardamom wholesaler, bulk cardamom export, spice exporter India, organic cardamom, cardamom manufacturer, Neo Enterprises, buy green cardamom online"
        />
        <meta name="author" content="Neo Enterprises" />
        <meta name="robots" content="index, follow" />

        <meta property="og:title" content="Cardamom Exporter from India | Neo Enterprises" />
        <meta
          property="og:description"
          content="Premium Green Cardamom (Elaichi) exporter from India — natural, aromatic, and export-quality spice from Neo Enterprises."
        />
        <meta property="og:type" content="product" />
        <meta property="og:url" content="https://theneoenterprises.com/products/cardamom" />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/cardamom.png" />
        <meta property="og:site_name" content="Neo Enterprises" />

        <link rel="canonical" href="https://theneoenterprises.com/products/cardamom" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Cardamom Exporter from India | Neo Enterprises" />
        <meta
          name="twitter:description"
          content="High-quality Green Cardamom (Elaichi) exported from India by Neo Enterprises — available in multiple grades and packaging options."
        />
        <meta name="twitter:image" content="https://theneoenterprises.com/images/products/cardamom.png" />
          ...
          {`
            {
              ...
              "@type": "Product",
              "name": "Cardamom",
              "image": "https://theneoenterprises.com/images/products/cardamom.png",
              "description": "Premium quality Green Cardamom (Elaichi) grown and exported from India by Neo Enterprises. Known for its strong aroma and rich flavor, suitable for culinary, pharmaceutical, and cosmetic applications.",
              "brand": {
                "@type": "Brand",
              ...
              "offers": {
                ...
                "priceCurrency": "USD",
                "url": "https://theneoenterprises.com/products/cardamom"
              },
              "additionalProperty": [
                {
                  "@type": "PropertyValue",
