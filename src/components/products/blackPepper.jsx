...
export default function BlackPepper() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Black Pepper Exporter from India | Neo Enterprises — Premium Quality Spices Manufacturer & Supplier
        </title>
        <meta
          name="description"
          content="Neo Enterprises is a leading exporter and supplier of premium-grade Black Pepper (Piper nigrum) from India. Ideal for culinary, food processing, and pharmaceutical uses. Available in whole, cracked, or ground form with guaranteed purity and rich aroma."
        />
        <meta
          name="keywords"
          content="Black Pepper exporter India, Piper nigrum supplier, bulk black pepper, Indian spices exporter, pepper wholesaler, organic black pepper, spice exporter India, Neo Enterprises, buy black pepper online"
        />
        <meta name="author" content="Neo Enterprises" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Black Pepper Exporter from India | Neo Enterprises" />
        <meta
          property="og:description"
          content="Trusted manufacturer and exporter of high-quality Black Pepper (Piper nigrum) from India — ideal for culinary, pharmaceutical, and industrial applications."
        />
        <meta property="og:type" content="product" />
        <meta property="og:url" content="https://theneoenterprises.com/products/blackPepper" />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/blackPepper.png" />
        <meta property="og:site_name" content="Neo Enterprises" />
        <link rel="canonical" href="https://theneoenterprises.com/products/blackPepper" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Black Pepper Exporter from India | Neo Enterprises" />
        <meta
          name="twitter:description"
          content="High-quality Black Pepper from India — available in whole, cracked, and ground forms. Exported globally by Neo Enterprises."
        />
        <meta name="twitter:image" content="https://theneoenterprises.com/images/products/blackPepper.png" />
          ...
          {`
            {
              ...
              "@type": "Product",
              "name": "Black Pepper",
              "image": "https://theneoenterprises.com/images/products/blackPepper.png",
              "description": "Premium quality Black Pepper (Piper nigrum) exported from India by Neo Enterprises. Ideal for culinary, medicinal, and industrial use.",
              "brand": {
                "@type": "Brand",
              ...
              "offers": {
                ...
                "priceCurrency": "USD",
                "url": "https://theneoenterprises.com/products/blackPepper"
              }
            }
          `}
        </script>
