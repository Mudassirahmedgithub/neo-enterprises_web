...
export default function Clove() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Makhana (Fox Nuts) Exporter from India | Neo Enterprises — Premium Lotus Seeds Manufacturer & Supplier
        </title>
        <meta
          name="description"
          content="Neo Enterprises is a trusted exporter and supplier of premium-quality Makhana (Fox Nuts) from India. Graded, sorted, and export-ready. Ideal for snacks, Ayurveda, and health industries."
        />
        <meta
          name="keywords"
          content="Makhana exporter India, Fox Nuts supplier, Lotus Seeds manufacturer, organic makhana exporter, premium fox nuts, Neo Enterprises, buy makhana in bulk, fox nuts wholesaler"
        />
        <meta name="author" content="Neo Enterprises" />
        <meta name="robots" content="index, follow" />

        <meta property="og:title" content="Makhana (Fox Nuts) Exporter from India | Neo Enterprises" />
        <meta
          property="og:description"
          content="Premium Makhana (Fox Nuts) exported from India by Neo Enterprises — naturally processed, rich in nutrition, and ideal for snacks and Ayurvedic uses."
        />
        <meta property="og:type" content="product" />
        <meta property="og:url" content="https://theneoenterprises.com/products/makhana" />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/lotusSeeds.png" />
        <meta property="og:site_name" content="Neo Enterprises" />

        <link rel="canonical" href="https://theneoenterprises.com/products/makhana" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Makhana (Fox Nuts) Exporter from India | Neo Enterprises" />
        <meta
          name="twitter:description"
          content="High-grade Makhana (Fox Nuts) from Neo Enterprises — cleaned, sorted, and packed for global exports. Used in health foods, snacks, and Ayurvedic formulations."
        />
        <meta name="twitter:image" content="https://theneoenterprises.com/images/products/lotusSeeds.png" />
          ...
          {`
            {
              ...
              "image": "https://theneoenterprises.com/images/products/lotusSeeds.png",
              "description": "Premium-grade Makhana (Fox Nuts), also known as Lotus Seeds, exported from India by Neo Enterprises. Ideal for health foods, Ayurveda, and global snack industries.",
              "brand": {
                "@type": "Brand",
              ...
              "offers": {
                ...
                "priceCurrency": "USD",
                "url": "https://theneoenterprises.com/products/makhana"
              },
              "additionalProperty": [
                {
                  "@type": "PropertyValue",
                ...
                },
                {
                  "@type": "PropertyValue",
                  "name": "Packaging Type",
                  "value": "PP Bags / Jute Bags / Custom"
                },
                {
                  "@type": "PropertyValue",
                  "name": "Grades Available",
                  "value": "Premium, 6 Plus Suta, 6 Suta, 5 Plus Suta, 5 Suta, 4 Plus, 4, 3, 1 Suta"
                },
                {
                  "@type": "PropertyValue",
                  "name": "Business Type",
                  "value": "Manufacturer, Exporter, Supplier"
                },
                {
                  "@type": "PropertyValue",
                  "name": "Shelf Life",
                ...
                },
                {
                  "@type": "PropertyValue",
                  "name": "Use Case",
                  "value": "Snacking, Export, Ayurvedic, Medicinal, Culinary"
                }
              ]
            }
          `}
