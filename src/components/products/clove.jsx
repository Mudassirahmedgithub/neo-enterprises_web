...
export default function Clove() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Clove Exporter from India | Neo Enterprises — Premium Dried Cloves Manufacturer & Supplier
        </title>
        <meta
          name="description"
          content="Neo Enterprises is a trusted exporter and supplier of high-quality Dried Cloves (Syzygium aromaticum) from India. Known for rich aroma, purity, and natural oil content. Suitable for culinary, pharmaceutical, and essential oil applications."
        />
        <meta
          name="keywords"
          content="Clove exporter India, dried cloves supplier, Syzygium aromaticum, bulk clove exporter, spice exporter India, clove wholesaler, organic cloves, Neo Enterprises, buy cloves online"
        />
        <meta name="author" content="Neo Enterprises" />
        <meta name="robots" content="index, follow" />

        <meta property="og:title" content="Clove Exporter from India | Neo Enterprises" />
        <meta
          property="og:description"
          content="Premium Dried Cloves (Syzygium aromaticum) exported from India by Neo Enterprises — ideal for food, pharmaceutical, and essential oil industries."
        />
        <meta property="og:type" content="product" />
        <meta property="og:url" content="https://theneoenterprises.com/products/clove" />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/clove.png" />
        <meta property="og:site_name" content="Neo Enterprises" />

        <link rel="canonical" href="https://theneoenterprises.com/products/clove" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Clove Exporter from India | Neo Enterprises" />
        <meta
          name="twitter:description"
          content="High-quality Dried Cloves (Syzygium aromaticum) exported globally by Neo Enterprises — available in bulk and customized packaging."
        />
        <meta name="twitter:image" content="https://theneoenterprises.com/images/products/clove.png" />
          ...
          {`
            {
              ...
              "@type": "Product",
              "name": "Clove",
              "image": "https://theneoenterprises.com/images/products/clove.png",
              "description": "Premium quality Dried Cloves (Syzygium aromaticum) exported from India by Neo Enterprises. Naturally dried and rich in essential oil, suitable for culinary, medicinal, and cosmetic applications.",
              "brand": {
                "@type": "Brand",
              ...
              "offers": {
                ...
                "priceCurrency": "USD",
                "url": "https://theneoenterprises.com/products/clove"
              },
              "additionalProperty": [
                {
                  "@type": "PropertyValue",
