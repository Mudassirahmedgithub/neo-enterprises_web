...
export default function SoyabeanMeal() {
  ...
  const handleSubmit = (e) => {
    ...
    submitForm('SoyabeanMealEnquiry', formData, setStatus, () =>
      setForm({
        name: '',
        email: '',
        countryCode: '91',
  ...
  return (
    <>
      <Helmet>
        <title>
          Soyabean Meal Exporter from India | Neo Enterprises — High Protein Animal Feed Manufacturer & Supplier
        </title>
        <meta
          name="description"
          content="Neo Enterprises is a leading manufacturer and exporter of premium-quality Soyabean Meal from India. Rich in protein and essential amino acids, ideal for poultry, dairy, and aquaculture feed industries."
        />
        <meta
          name="keywords"
          content="Soyabean Meal exporter India, soybean meal supplier, animal feed protein, soy meal manufacturer, Neo Enterprises, soyabean feed exporter, high protein cattle feed, poultry feed ingredient"
        />
        <meta name="author" content="Neo Enterprises" />
        <meta name="robots" content="index, follow" />

        <meta property="og:title" content="Soyabean Meal Exporter from India | Neo Enterprises" />
        <meta
          property="og:description"
          content="Premium-quality Soyabean Meal exported by Neo Enterprises — a trusted supplier of high-protein animal feed ingredients from India."
        />
        <meta property="og:type" content="product" />
        <meta property="og:url" content="https://theneoenterprises.com/products/soyabeanMeal" />
        <meta property="og:image" content="https://theneoenterprises.com/images/products/SoyabeanMeal.png" />
        <meta property="og:site_name" content="Neo Enterprises" />

        <link rel="canonical" href="https://theneoenterprises.com/products/soyabeanMeal" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Soyabean Meal Exporter from India | Neo Enterprises" />
        <meta
          name="twitter:description"
          content="Export-quality Soyabean Meal rich in protein and nutrients — supplied globally by Neo Enterprises for livestock, poultry, and aquaculture feed."
        />
        <meta name="twitter:image" content="https://theneoenterprises.com/images/products/SoyabeanMeal.png" />
          ...
          {`
            {
              ...
              "@type": "Product",
              "name": "Soyabean Meal",
              "image": "https://theneoenterprises.com/images/products/SoyabeanMeal.png",
              "description": "High-protein Soyabean Meal (46–48% protein), processed and exported by Neo Enterprises. Ideal for animal feed, poultry, aquaculture, and organic fertilizer applications.",
              "brand": {
                "@type": "Brand",
              ...
              "offers": {
                ...
                "priceCurrency": "USD",
                "url": "https://theneoenterprises.com/products/soyabeanMeal"
              },
              "additionalProperty": [
                {
                  "@type": "PropertyValue",
                ...
                },
                {
                  "@type": "PropertyValue",
                  "name": "Use Case",
                  "value": "Animal Feed, Dairy, Poultry, Aquaculture, Organic Fertilizer"
                }
              ]
            }
          `}
